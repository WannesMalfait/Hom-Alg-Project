...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item $\Hom_{\Ab(X)}(f^*\mcG, \mcF) = \Hom_{\Ab(Y)}(\mcG, f_*\mcF)$.
              ...
              TODO: naturality in $\mcF$ and $\mcG$.
...
$f\colon \underline{\bbR_{\text{discrete}}} \to \underline{\bbR_{\text{Euclidian}}}$
...
\begin{definition}
    ...
    in the category of compact Hausdorff spaces\footnote{
        ...
        every open set must again be open. In this case,
        the two definitions are equivalent
        (\cite[Theorem 2.5]{Gle1958ProjectiveTS})}.
\end{definition}

One can show that every compact Hausdorff space is the
surjective image of an extremally disconnected set,
i.e. the category has enough projectives
(\cite[Theorem 3.2]{Gle1958ProjectiveTS}).
TODO:
- Show that category of $\kappa$-condensed equivalent to extremally disconnected version.
- Show that limits and colimits can be taken section-wise.
